---
name: deploy
description: Deploy MimiClaw firmware to an ESP32-C3 board. Covers prerequisites, configuration, build, flash, verification, and troubleshooting.
---

# Deploy MimiClaw

End-to-end guide for deploying MimiClaw to an ESP32-C3 dev board.

## Prerequisites

### Hardware
- ESP32-C3 dev board with **16 MB flash + No PSRAM** (e.g. Xiaozhi AI board, ~$5-10)
- USB Type-C data cable (not charge-only)

### Software
- **ESP-IDF v5.5+** installed and working
  ```bash
  # Install: https://docs.espressif.com/projects/esp-idf/en/v5.5.2/esp32c3/get-started/
  # Verify:
...
#define MIMI_SECRET_MODEL           "MiniMax-M2.5-highspeed"
...
```
I (xxx) mimi: MimiClaw - ESP32-C3 AI Agent
